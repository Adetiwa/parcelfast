...
import { View, Image, TextInput, StatusBar, Dimensions, Platform , TouchableOpacity} from "react-native";
...
class Payment extends Component {
	...
	componentWillMount(){
		...
		if(!this.props.card_exist) {
		  ...
		  this.getIcon(this.props.card_type);
	  }
	  ...
	  getIcon(type){
			switch(type) {
				case 'master-card':
					return <Image style={{width: 35, height: 35, resizeMode: Image.resizeMode.contain, }} source={{uri: master}}/>
				case 'visa':
					return <Image style={{width: 35, height: 35, resizeMode: Image.resizeMode.contain, }} source={{uri: visa}}/>
				case 'american-express':
					return <Image style={{width: 35, height: 35, resizeMode: Image.resizeMode.contain, }} source={{uri: american}}/>
				case 'discover':
					return <Image style={{width: 35, height: 35, resizeMode: Image.resizeMode.contain, }} source={{uri: discover}}/>
				case 'jcb':
					return <Image style={{width: 35, height: 35, resizeMode: Image.resizeMode.contain, }} source={{uri: jcb}}/>
				case 'diners-club':
					return <Image style={{width: 35, height: 35, resizeMode: Image.resizeMode.contain, }} source={{uri: diners}}/>
				case 'cvc_amex':
					return <Image style={{width: 35, height: 35, resizeMode: Image.resizeMode.contain, }} source={{uri: cvc_amex}}/>
				default:
					return 	<Icon style = {{color: '#888' }}name='card' /> 
			}
	  }
	render() {
		return (
				...
				<Content>
					<Separator bordered>
						...
						<ListItem
								onPress={() => this.props.navigation.navigate('CardView')}
								>
								<Text>{this.props.card_exist ? `**** **** **** ${this.props.last_4}` : 'CREDIT/DEBIT CARD'}</Text>
								<Right>
									{this.getIcon(this.props.card_type)}
								</Right>
